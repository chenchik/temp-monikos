...
<!--           <a href='#'><div class = "game-block game-white" id ='game_3'>MULTIPLE CHOICE<br>QUIZ</div></a>-->
            ...
            <div class = "flex-item " id ='challenge-block' ng-init="img=getImg()" ng-click="payment()"><span id='challengeText'>CHALLENGE A<br>FRIEND<br><img ng-src="{{img}}" width="150px" height="140px"></span>
