    ...
    <a style="display: none" id="payment" ng-click="payment()"><button class = 'upgrade'>Upgrade</button></a>
        ...
        <div id="content_wrapper">
            ...
            <div id="page-navigate" style="text-align:center">
                ...
                <button type="button" class="pageNum" ng-repeat="page in pages" ng-click=goToPage(page)>
                    {{page}}
                </button>
            </div>
            ...
            <div class="drug-block" ng-if="pg4" ng-click='showPopup("info" + x.DrugId);$event.stopPropagation()' ng-repeat="x in names | filter:searchText | limitTo:50:100">
                <div class=drug-content>
                    <div class="visible-info">
                        <div class="drug-generic">
                            {{x.Generic}}
            ...
            <div class="drug-block" ng-if="pg5" ng-click='showPopup("info" + x.DrugId);$event.stopPropagation()' ng-repeat="x in names | filter:searchText | limitTo:50:150">
                <div class=drug-content>
                    <div class="visible-info">
                        <div class="drug-generic">
                            {{x.Generic}}
            ...
            <div class="drug-block" ng-if="pg6" ng-click='showPopup("info" + x.DrugId);$event.stopPropagation()' ng-repeat="x in names | filter:searchText | limitTo:50:200">
                <div class=drug-content>
                    <div class="visible-info">
                        <div class="drug-generic">
                            {{x.Generic}}
            ...
            <div class="drug-block" ng-if="pg7" ng-click='showPopup("info" + x.DrugId);$event.stopPropagation()' ng-repeat="x in names | filter:searchText | limitTo:50:250">
                <div class=drug-content>
                    <div class="visible-info">
                        <div class="drug-generic">
                            {{x.Generic}}
